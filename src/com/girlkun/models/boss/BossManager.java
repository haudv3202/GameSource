...
import com.girlkun.models.boss.list_boss.BossTrau;
...
import com.girlkun.models.boss.list_boss.gokuvocuc;
...
//                    return new BlackGokuBase();
                ...
                case BossID.BROLY:
                    return new Broly();
                case BossID.Gokuvocuc:
                    return new gokuvocuc();
                case BossID.BossTienBip:
