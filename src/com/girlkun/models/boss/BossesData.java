...
// {27, 28, 29, 30, 6, 13, 10, 33, 34, 32, 31, 20, 19, 37, 38, 36, 35}
    public static final BossData Boss_Thuong_De = new BossData(
            "Thượng Đế", //name
            ...
            new String[]{"|-1|Khá lắm con trai, dám phá tan giấc mộng của ta...",
                "|-1|Ta không thấy đám Con Người đâu,... các ngươi đã giết chúng rồi à?",
       ...
       public static final BossData Boss_Than_Vu_Tru = new BossData(
            "Thần Vũ Trụ", //name
           ...
           new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                {Skill.LIEN_HOAN, 7, 1000},
            {Skill.TAI_TAO_NANG_LUONG, 4, 10000}}, //skill
            ...
            new String[]{"|-1|Oải rồi hả?",
                ...
                "|-1|Muốn có đệ Goku Hả ? Nhào zô mà ăn nè!",
...
//                    {Skill.BIEN_KHI, 5, 100000}
    ...
    public static final BossData BLACK_GOKU = new BossData(
            ...
            new String[]{"|-1|Biến hình! Super Sayan Rose"}, //text chat 3
            REST_20_M //second rest Sua cai nay la thoi gian hoi sinh boss sua thanh 20p la
//            thanh 20_M
    );
...
//                {Skill.TAI_TAO_NANG_LUONG, 4, 80000},
    ...
    public static final BossData THANZM2 = new BossData(
       ...
       public static final BossData BOSSNEW = new BossData(
            "Boss Yarirobe", //name
            ConstPlayer.TRAI_DAT, //gender
...
//            29,13,20,
            ...
            new int[][]{
                ...
                {Skill.LIEN_HOAN, 7, 100},
                {Skill.KHIEN_NANG_LUONG, 4, 20000},
...
//                {Skill.TU_SAT, 7, 100000},
                {Skill.KHIEN_NANG_LUONG, 3, 80000},
                {Skill.DE_TRUNG, 3, 10000},
                {Skill.LIEN_HOAN, 7, 100},
                {Skill.DEMON, 7, 1000}},
            new String[]{"|-2|Ma nhân Bư đã xuất hiện rồi"}, //text chat 1
            new String[]{"|-1|Thấy ảo chưa nè!"}, //text chat 2
...
//                                    {Skill.TAI_TAO_NANG_LUONG, 7, 12000},
    ...
    public static final BossData BOSS_Namec_Phan_Dien = new BossData(
            ...
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.KHIEN_NANG_LUONG, 7, 17000},
                {Skill.THAI_DUONG_HA_SAN, 3, 10000},
                {Skill.LIEN_HOAN, 7, 300},},//skill//skill
            new String[]{"|-2|Hắn Ta đã xuất hiện"}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                "|-1|HaHa Phản diện thì sao",
                "|-1|Chúng mày yếu thế",
                "|-1|Mấy con gà,Nhào zô",}, //text chat 2
            new String[]{"|-1|Cứ đợi đấy !"}, //text chat 3
            REST_5_M
    );
